(function ($) {
    ...
    $.uiExe = {
        ...
        main: {
            ...
            /*
             newsAjax: function (target) {
             return $.ajax({
             type: "GET",
             cache: false,
             url: '/news.html',
             success: function (data) {
             $('.news-swipe .swiper-wrapper').html(data);
             
             new Swiper('.news-swipe', {
             nested: true,
             centeredSlides: true,
             followFinger: true                           
            ...
            newsSwipe: function (frame) {
                ...
                var newsNav = new Swiper('.news-nav', {
                    centeredSlides: true,
                    slidesPerView: '3',
                    onInit: function (swiper) {
                        if (frame) {                           
                ...
                newsGall.params.control = newsNav;
                newsNav.params.control = newsGall;
            ...
            /*
             urlOpen: function (mainLayer) {
             var urlOpen = this.mainSwipe;
             urlOpen().slideTo(mainLayer);
             }            
             */
            ...
            detailAjaxSave: function (hrefIndex, target, target2) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        inner += "<a href=" + data[hrefIndex].detailLink + " target='_blank'>구매하기</a>"
                        inner += "<a href=" + data[hrefIndex].detailRelative + " target='_blank'>관련 컨텐츠 보기</a>"
                        inner += "</div>"
                        inner += "</div>"
                        inner += "</div>"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (layer_results == 6) {
                            ...
                            inner += "<video id='introVideo" + frame_results + "' preload='auto' controls>"
